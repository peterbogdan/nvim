...
keymap("n", "<TAB>", "<cmd>lua vim.lsp.buf.signature_help()<CR>", opts) -- TODO: Test
keymap("n", "<leader>q", "<cmd>Bdelete!<CR>", opts)
keymap("n", "<F1>", ":e $NOTES_PATH<cr>", opts)
...
keymap("n", "gx", [[: execute '!open -a firefox ' . shellescape(expand('<cfile>'), 1)<CR>]], opts)
...
-- Comment
keymap("n", "<m-/>", "<cmd>lua require('Comment.api').toggle.linewise.current()<CR>", opts)
